...
func MakeHandler(bs Service, logger kitlog.Logger) http.Handler {
	...
	r.Handle("/releation/v1/user/{user_id}/role", getRoleHandler).Methods("GET")
	r.Handle("/releation/v1/user/role", getAllRoleHandler).Methods("GET")
	r.Handle("/releation/v1/user/role", addRoleHandler).Methods("POST")
	// r.Handle("/roleing/v1/role/{id}", deleteRoleHandler).Methods("DELETE")
	r.Handle("/releation/v1/user/role", deleteMultiRoleHandler).Methods("DELETE")
	// r.Handle("/roleing/v1/role/{id}", updateRoleHandler).Methods("PUT")
	r.Handle("/releation/v1/user/role", updateMultiRoleHandler).Methods("PUT")
	return r
}
